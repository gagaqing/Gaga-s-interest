...
enum SettingName: String {
    ...
    case help = "Help"
    case switchAount = "Switch Account"
    case cancel = "Cancel"
}
...
class SettingsLauncher: NSObject, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let settings: [Setting] = {
        ...
        let switchAountSetting = Setting(name: .switchAount, imageName: "switch_account")
        let cancelSetting = Setting(name: .cancel, imageName: "cancel")

        return [settingsSetting, privacySetting, feedBackSetting, helpSetting, switchAountSetting, cancelSetting]
    }()
